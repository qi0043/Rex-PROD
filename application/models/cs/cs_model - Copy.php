...
class cs_model extends CI_Model {
	...
	{
		$sql_get_sup_info ="SELECT id FROM tbl_rhd_supervisors WHERE supv_fan LIKE ?";
    ...
    CAST((xpath('//xml/item/progression/milestone/@name', XMLPARSE(CONTENT item_xml.xml)) )[1] AS TEXT) \"milestone_name\",
