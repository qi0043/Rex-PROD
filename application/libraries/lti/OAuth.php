...
class OAuthRequest {
  ...
  public static function from_request($http_method=NULL, $http_url=NULL, $parameters=NULL) {
    ...
    if (!$parameters) {
     ...
     // Add POST Parameters if they exist
      ...
      }#### request from flo does not have Authorization header with OAuth
  ...
  public function get_normalized_http_url() {
    ...
    #if(isset($parts['port'])) #### with @ there is still error reported.
    #$port = @$parts['port'];
    $port = isset($parts['port'])? $parts['port'] : null; #### with @ there is still error reported.
    $scheme = $parts['scheme'];
    $host = $parts['host'];
    $path = @$parts['path'];
