...
class UpdateData extends CI_Controller
{
    ...
    private function update_student($student_array)
    {
        ...
        foreach ($student_array as $student) {
            ...
            if ($milestone != 0) {
              ...
              #exit;
                ...
                if ($last_mod > $flex_student_update) {
                    ...
                    // move code to process and update student data in here
            ...
            if ($submit_thesis !== 0) {
				...
				// set the value
				$this->$xmlwrapper_submit_thesis->setNodeValue($student_update, $current_timestamp);
    ...
    private function update_supervisor($duplicates, $supervisors)
    {
        ...
        foreach ($student_supervisors as $stu_fan => $supervisor_array) {
            ...
            $last_mod = strtotime($principal['last_mod_ts']);
  ...
  */
    ...
    public function supervisors()
    {
        try {
            ...
            $supervisors = $this->cs_model->vw_rhd_mods_stusupv();
