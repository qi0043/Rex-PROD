...
class Showmilestone extends CI_Controller
{
    ...
    protected function milestoneXml2Array($itemXml, $attachmentInfo)
    {
        ...
        $publish_input_text = '/xml/item/support/mentoring/publishing/reviewer/comment';
        $milestoneArray['metadata']['publish']['comment'] = $itemXml->nodeValue($publish_input_text);
	...
	*/
    ...
    public function attach_pdf_lx9n3h2($uuid='missed', $version='missed')
    {
        ...
        $filename = $data['milestone_array']['metadata']['thesistitle'] . '_' . $refValue->format('c') . '.pdf';
