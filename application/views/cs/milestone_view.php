...
<body id="bodytag">
    ...
    <p style="font-size: smaller; color:DimGrey; float: left">Flinders University:
        ...
        {
            echo '<i>report finalised; generated&nbsp;'. $milestone_array['metadata']['approval_date']. '</i>';
        }
        else
        {
            #echo '<i>generated on&nbsp;' . $displayDate.'</i>';
            echo 'report finalised; generated&nbsp;' . $displayDate.'</i>';
        }?>
        ...
        <div class="sectioncontentdiv">
		    ...
		    ?>
                ...
                <div class="contentdiv">
                    ...
                    <div class="comments">
                    <?php
                        if(isset($milestone_array['metadata']['researchproblem']['inputs']['uuid']) || !empty($milestone_array['metadata']['researchproblem']['inputs']['text'])) {
                            echo !empty($milestone_array['metadata']['researchproblem']['inputs']['text'])? $milestone_array['metadata']['researchproblem']['inputs']['text']:"";
        ...
        <div class="sectioncontentdiv">
            <div class="contentdiv">
                ...
                <p class="p_item">
                    ...
                    <p class="p_item">
                        Do you recommend that the student be considered by the College for approval for a change of candidature from Masters by Research to PhD ? &nbsp; <b><?php echo isset($milestone_array['metadata']['supervisor']['judgement']) && $milestone_array['metadata']['supervisor']['judgement'] != ''?$milestone_array['metadata']['supervisor']['judgement'] : '' ?></b>
                    </p>
        ...
        <div class="sectiondiv ">
            ...
            <div class="sectioncontentdiv ">
                <div class="contentdiv">
                    ...
                    <ul>
                        <li>You may raise concerns in confidence and independently of this Milestone with the Chair, College Research Higher Degrees Committee, Dean of School, Research Higher Degrees Contact Officers, or any of the student support services.</li>
                        ...
                        <li>For contact details refer to: <a href="https://rex.flinders.edu.au/items/192a7d57-0ff0-40bb-9de1-e8a663eee204/1/?attachment.uuid=4529d401-344f-4a2e-9c0a-54e10391425f" target="_blank ">Academic and Administrative support</a></li>
                    </ul>-->
                ...
                <div class="contentdiv ">
                    ...
                    <p class="p_item ">
                        Does the College approve the Milestone recommendation? &nbsp;
                        <?php
                ...
                ?>
               		(on behalf of Chair, College RHD Committee)
                    </p>
                   <p>
                        Date:
