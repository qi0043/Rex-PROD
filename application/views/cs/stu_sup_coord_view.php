...
<?php
if(!isset($this->session->userdata['user_role']) || !isset($this->session->userdata['fan']) || ! isset($this->session->userdata['stu_id']) || !isset($this->session->userdata['sup_id']) || !isset($this->session->userdata['coordinator_fan']))
{?>
...
elseif($this->session->userdata['user_role'] != 'student_supervisor_coordinator')
{?>
	<div class="container container-gap">
    	...
    	<div class="panel panel-default">
            ...
            <div class="panel-body">
            	<ul class="panel-ul">
                    ...
                    <li class="panel-li"><a  href="<?php echo base_url('cs/supervisor'). '/'. $this->session->userdata['fan'] .'/'; ?>">RHD Supervisor</a></li>
