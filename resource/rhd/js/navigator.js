...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(Li, [{
	        ...
	        value: function render() {
	            ...
	            if (this.props.valid == 'invalid') {
	                valid_mark = _react2.default.createElement('i', { className: 'glyphicon glyphicon-exclamation-sign' });
	            }
	            var a_link = this.props.url != "" ? _react2.default.createElement(
	                'a',
	                { href: this.props.url },
	                this.props.text,
	                ' ',
	...
	var Navigator = function (_React$Component2) {
	    ...
	    function Navigator(props) {
	        ...
	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Navigator).call(this, props)); /* Note props is passed into the constructor in order to be used */
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.state.items.map(function (i) {
	                        return _react2.default.createElement(Li, { key: i.index, active: i.active, url: i.url, text: i.text, disabled: i.disabled, valid: i.valid });
	                    })
	                )
	            );
	        }
	...
	_reactDom2.default.render(_react2.default.createElement(Navigator, { items: data }), document.getElementById('thesis_navigator'));
