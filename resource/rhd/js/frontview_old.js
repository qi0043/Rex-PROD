...
/***/ function(module, exports, __webpack_require__) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'p',
							null,
							'Check that you are familiar with how to prepare for submission of your final thesis:'
						),
						_react2.default.createElement(
							'ul',
							null,
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'a',
									{ href: 'http://flinders.libguides.com/thesisdeposit', target: '_blank' },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'li',
								null,
								'The topic code you are enrolled in for your research component, eg.  ENGR9700D and PHCA9512. Do not use code like ENGR9700A-D.'
							),
							_react2.default.createElement(
								'li',
								null,
								'The title of your thesis and the abstract — to copy and paste into the submission.'
							),
							_react2.default.createElement(
								'li',
								null,
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'li',
										null,
										'All files that make up the final, approved version of your thesis.'
									)
								)
							),
							_react2.default.createElement(
								'li',
								null,
								'Keywords to help people find your thesis.'
							)
						),
						_react2.default.createElement(
							'p',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'li',
								null,
								'An open access version of your thesis '
							),
							_react2.default.createElement(
								'li',
								null,
								'A PDF version of your abstract if it has unusual formating.'
							)
						),
						_react2.default.createElement(
							'p',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'li',
								null,
								'You will need to enter the reason for the request.'
							)
						)
					)
				);
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'i',
									null,
									'This website is for Coursework students whose thesis has been examined, and where it needs to be deposited in the Library.'
								)
							)
						),
						_react2.default.createElement(
	...
	var Button = function (_React$Component3) {
		...
		_createClass(Button, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'button',
					{ type: 'button', className: 'btn btn-primary submitButton', onClick: this.props.buttonClick },
					this.props.text
				);
			}
		}]);
	...
	var Content = function (_React$Component4) {
		...
		function Content(props) {
			...
			var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(Content).call(this, props)); /* Note props is passed into the constructor in order to be used */
			...
			_this4.submitThesis = _this4.submitThesis.bind(_this4);
			return _this4;
		}
	
		_createClass(Content, [{
			key: 'submitThesis',
			value: function submitThesis() {
				var data = {};
				...
				switch (this.props.status) {
					case 'draft':
						text = _react2.default.createElement(
							...
							_react2.default.createElement(
								'i',
								null,
								'This thesis deposit is not finished.'
							)
						);
						if (this.props.valid) {
							staus_statement = _react2.default.createElement(
								'strong',
								null,
								' Please finalise and submit for publication. '
							);
							button = _react2.default.createElement(
								'div',
								null,
								_react2.default.createElement(Button, { buttonClick: this.viewThesis, text: 'Edit' }),
								'     ',
								_react2.default.createElement(Button, { buttonClick: this.submitThesis, text: 'Submit for publication' })
							);
						} else {
							staus_statement = _react2.default.createElement(
								'span',
								{ className: '' },
								' Thesis deposit incomplete. '
							);
							button = _react2.default.createElement(Button, { buttonClick: this.viewThesis, text: 'Complete thesis deposit' });
						}
						break;
					...
					case 'moderating':
						text = _react2.default.createElement(
							...
							_react2.default.createElement(
								'i',
								null,
								'Congratulations. You have successfully uploaded your thesis to the Flinders University Thesis collection.'
							)
						);
						...
						staus_statement = _react2.default.createElement(
							'span',
							{ className: 'lead' },
							' Thesis deposit in moderation (by Faculty, DVCA, Library).'
						);
	
						button = _react2.default.createElement(Button, { buttonClick: this.viewThesis, text: 'View submission' });
						break;
					...
					case 'live':
						...
						link = _react2.default.createElement(
							'div',
							{ className: 'public_div' },
							_react2.default.createElement(
								'a',
								{ href: href, target: '_blank' },
								'View thesis public page'
							)
						);
						button = '';
						break;
					...
					case 'rejected':
						staus_statement = _react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ href: 'mailto:flex.help@flinders.edu.au' },
								'flex.help@flinders.edu.au'
							),
							' to redraft your thesis.'
						);
						button = _react2.default.createElement(Button, { buttonClick: this.viewThesis, text: 'View submission' });
						break;
		...
		_createClass(App, [{
			...
			value: function render() {
				...
				if (this.props.status == 'notCreated') {
					content = _react2.default.createElement(New, null);
				} else {
					content = _react2.default.createElement(Content, { uuid: this.props.uuid, version: this.props.version, name: this.props.name, valid: this.props.valid, status: this.props.status });
				}
				return _react2.default.createElement(
					'div',
					{ className: 'col-md-12' },
					...
					_react2.default.createElement(Help, null)
				);
			}
		}]);
	...
	_reactDom2.default.render(_react2.default.createElement(App, { uuid: uuid, version: version, name: name, valid: valid, status: status }), document.getElementById('content'));
