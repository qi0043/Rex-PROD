...
/***/ function(module, exports, __webpack_require__) {
	...
	var Submit_button = function (_React$Component) {
		_inherits(Submit_button, _React$Component);
	
		function Submit_button(props) {
			_classCallCheck(this, Submit_button);
	
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Submit_button).call(this, props)); /* Note props is passed into the constructor in order to be used */
		...
		_createClass(Submit_button, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ type: 'button', className: 'btn btn-primary', onClick: this.handleSubmit, disabled: this.props.disabled },
						this.props.text
					)
				);
			}
	...
	_reactDom2.default.render(_react2.default.createElement(Submit_button, { newThesis: newThesis, text: 'Submit for Publication', disabled: disabled }), document.getElementById('submit_button'));
