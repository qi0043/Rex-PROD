...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(Button, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'button',
					{ type: 'button', className: 'btn btn-primary', onClick: this.props.buttonClick },
					this.props.text
				);
			}
		}]);
	...
	var MinusButton = function (_React$Component2) {
		_inherits(MinusButton, _React$Component2);
	
		function MinusButton() {
			_classCallCheck(this, MinusButton);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(MinusButton).apply(this, arguments));
		}
		...
		_createClass(MinusButton, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'col-md-1 icon' },
					_react2.default.createElement('i', { onClick: this.props.clickHandler, title: 'Remove', className: 'glyphicon glyphicon-remove-sign' })
				);
			}
		}]);
	...
	var RemoveButton = function (_React$Component3) {
		_inherits(RemoveButton, _React$Component3);
		...
		_createClass(RemoveButton, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'col-md-1 icon' },
					_react2.default.createElement('i', { onClick: this.props.clickHandler, title: 'Remove', className: 'glyphicon glyphicon-trash' })
				);
			}
		}]);
	...
	var DownloadButton = function (_React$Component4) {
		...
		function DownloadButton(props) {
			...
			var _this4 = _possibleConstructorReturn(this, Object.getPrototypeOf(DownloadButton).call(this, props));
	
			_this4.download_click = _this4.download_click.bind(_this4);
			return _this4;
		}
	
		_createClass(DownloadButton, [{
			key: 'download_click',
			value: function download_click(e) {
				e.preventDefault();
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ href: this.props.url, title: 'Download', target: '_blank' },
	...
	var UndoButton = function (_React$Component5) {
		_inherits(UndoButton, _React$Component5);
	
		function UndoButton() {
			_classCallCheck(this, UndoButton);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(UndoButton).apply(this, arguments));
		}
		...
		_createClass(UndoButton, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'col-md-1' },
					_react2.default.createElement('i', { onClick: this.props.clickHandler, title: 'Undo', className: 'glyphicon glyphicon-step-backward' })
				);
			}
		}]);
	...
	var InputError = function (_React$Component6) {
		_inherits(InputError, _React$Component6);
		...
		_createClass(InputError, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ style: error_style, className: this.props.visible ? 'visible' : 'invisible' },
					_react2.default.createElement(
						'span',
						{ style: error_style },
						'* ',
	...
	var FileUploader = function (_React$Component7) {
		_inherits(FileUploader, _React$Component7);
	
		function FileUploader(props) {
			_classCallCheck(this, FileUploader);
	
			var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(FileUploader).call(this, props));
	
			_this7.state = {
				readonly: _this7.props.readonly,
				attachment: '',
				help: _this7.props.help,
				error: false,
				errorMsg: ''
			};
			_this7.restart = _this7.restart.bind(_this7);
			_this7.editMode = _this7.editMode.bind(_this7);
			_this7.readOnlyMode = _this7.readOnlyMode.bind(_this7);
			_this7.fileUpload = _this7.fileUpload.bind(_this7);
			_this7.validation = _this7.validation.bind(_this7);
			_this7.editHelpMsg = _this7.editHelpMsg.bind(_this7);
			return _this7;
		}
		...
		_createClass(FileUploader, [{
						...
						if (file.size > 0 && file.type != 'application/pdf' && file.type != 'application/x-zip-compressed') {
							...
							_this8.setState({
								help: _react2.default.createElement(
									'div',
									{ style: error_style },
									'[Warning] No File chosen, please upload a pdf or zip file'
								),
								upload_button_visible: false
							});
						} else {
			...
			key: 'editHelpMsg',
			value: function editHelpMsg(msg) {
				this.setState({
					help: msg
				});
			}
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					null,
					error,
					_react2.default.createElement('input', { type: 'file', className: 'file_upload form-control-file', ref: 'file_attachment', name: 'thesisfiles[]', onChange: this.fileUpload, disabled: this.state.readonly }),
					_react2.default.createElement(
						'h5',
	...
	var DefaultFile = function (_React$Component8) {
		_inherits(DefaultFile, _React$Component8);
	
		function DefaultFile(props) {
			_classCallCheck(this, DefaultFile);
	
			var _this9 = _possibleConstructorReturn(this, Object.getPrototypeOf(DefaultFile).call(this, props));
	
			var text = '';
			if (_this9.props.default_file_name != '') {
				var str = 'File: ' + _this9.props.default_file_name + ' uploaded.';
				var size = ' - file size: ' + formatBytes(_this9.props.default_file_size);
				...
				text = _this9.props.help;
			}
			_this9.state = {
				text: text
			};
			_this9.restart = _this9.restart.bind(_this9);
			return _this9;
		}
	
		_createClass(DefaultFile, [{
			key: 'restart',
			value: function restart() {
				var text = '';
			...
			key: 'render',
			value: function render() {
				var download_link = this.props.file_link ? _react2.default.createElement(DownloadButton, { url: this.props.file_link }) : '';
				return _react2.default.createElement(
					'div',
					{ className: 'row' },
					_react2.default.createElement(
	...
	var FileWrapper = function (_React$Component9) {
		_inherits(FileWrapper, _React$Component9);
	
		function FileWrapper(props) {
			_classCallCheck(this, FileWrapper);
	
			var _this10 = _possibleConstructorReturn(this, Object.getPrototypeOf(FileWrapper).call(this, props));
	
			_this10.state = {
				visible: true,
				count: _this10.props.count,
				readonly: _this10.props.readonly,
				default_file: _this10.props.default_file_name ? true : false,
				uuid: _this10.props.uuid ? _this10.props.uuid : ''
			};
			_this10.clickHandler = _this10.clickHandler.bind(_this10);
			_this10.editMode = _this10.editMode.bind(_this10);
			_this10.readOnlyMode = _this10.readOnlyMode.bind(_this10);
			_this10.restart = _this10.restart.bind(_this10);
			_this10.removeClickHandler = _this10.removeClickHandler.bind(_this10);
			_this10.undoClickHandler = _this10.undoClickHandler.bind(_this10);
			_this10.validation = _this10.validation.bind(_this10);
			return _this10;
		}
		...
		_createClass(FileWrapper, [{
			...
			key: 'undoClickHandler',
			value: function undoClickHandler() {
				this.setState({
					default_file: true
				});
			}
			...
			key: 'render',
			value: function render() {
				var remove_button = this.state.readonly ? '' : _react2.default.createElement(RemoveButton, { clickHandler: this.removeClickHandler });
				var undo_button = this.props.default_file_name ? _react2.default.createElement(UndoButton, { clickHandler: this.undoClickHandler }) : _react2.default.createElement('div', null);
				var muniusbutton = this.state.visible && !this.state.readonly && this.state.count > 1 ? _react2.default.createElement(MinusButton, { clickHandler: this.clickHandler }) : '';
	
				var file = this.state.default_file ? _react2.default.createElement(
					'div',
					{ className: 'row' },
					_react2.default.createElement(
						'div',
						{ className: 'col-md-10' },
						_react2.default.createElement(DefaultFile, { default_file_name: this.props.default_file_name, default_file_size: this.props.default_file_size, file_link: this.props.default_file_link, help: this.props.help })
					),
					' ',
					remove_button,
					muniusbutton
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-md-10' },
						_react2.default.createElement(FileUploader, { help: this.props.help, ref: 'file_uploader', readonly: this.state.readonly })
					),
					undo_button,
					' ',
					muniusbutton
	...
	var FileControl = function (_React$Component10) {
		_inherits(FileControl, _React$Component10);
	
		function FileControl(props) {
			_classCallCheck(this, FileControl);
	
			var _this11 = _possibleConstructorReturn(this, Object.getPrototypeOf(FileControl).call(this, props));
	
			if (_this11.props.thesisType == 'examined') {
				if (examinedTheses.length > 0) {
					for (var i = 0; i < examinedTheses.length; i++) {
						examinedTheses[i].readonly = _this11.props.readonly;
						examinedTheses[i].help = _this11.props.help;
					}
					_this11.state = {
					...
					temp["readonly"] = _this11.props.readonly;
					temp["help"] = _this11.props.help;
					items.push(temp);
					_this11.state = {
						loading: false,
						readonly: _this11.props.readonly,
			...
			} else if (_this11.props.thesisType == 'openAccess') {
				if (openAccessTheses.length > 0) {
					for (var i = 0; i < openAccessTheses.length; i++) {
						openAccessTheses[i].readonly = _this11.props.readonly;
						openAccessTheses[i].help = _this11.props.help;
					}
					_this11.state = {
						readonly: _this11.props.readonly,
						error: false,
			...
			_this11.editMode = _this11.editMode.bind(_this11);
			_this11.handleResetClick = _this11.handleResetClick.bind(_this11);
			_this11.readOnlyMode = _this11.readOnlyMode.bind(_this11);
			_this11.restart = _this11.restart.bind(_this11);
			_this11.handleAddClick = _this11.handleAddClick.bind(_this11);
			_this11.validation = _this11.validation.bind(_this11);
			return _this11;
		}
		...
		_createClass(FileControl, [{
			...
			value: function render() {
				var loading = this.state.loading ? _react2.default.createElement(
					'div',
					{ className: 'spinner-wave', style: spinner_wave_style },
					_react2.default.createElement('div', { style: spinner_style }),
					_react2.default.createElement('div', { style: spinner_style }),
					_react2.default.createElement('div', { style: spinner_style }),
					_react2.default.createElement('div', { style: spinner_style }),
					_react2.default.createElement('div', { style: spinner_style }),
					_react2.default.createElement(
						'p',
						{ style: spinner_style, id: 'txt_loading' },
						' Loading...'
					)
				) : _react2.default.createElement('div', null);
				var error = this.state.error ? _react2.default.createElement(
					'div',
					{ className: 'alert alert-danger', role: 'alert', id: 'error_examined' },
					_react2.default.createElement(
						'button',
				...
				var addButton = this.state.readonly ? _react2.default.createElement(
					'button',
					{ type: 'button', className: 'btn btn-default', onClick: this.handleAddClick, disabled: true },
					'Add another file'
				) : _react2.default.createElement(
					'button',
					{ type: 'button', className: 'btn btn-default', onClick: this.handleAddClick },
					'Add another file'
				);
				return _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						...
						this.state.items.map(function (i) {
							return _react2.default.createElement(FileWrapper, { key: i.item, help: i.help, count: i.item, default_file_name: i.default_file_name, default_file_size: i.default_file_size, default_file_link: i.default_file_link, readonly: i.readonly, ref: i.ref_name, uuid: i.uuid });
						})
					),
					_react2.default.createElement(
						'div',
	...
	var File = function (_React$Component11) {
		_inherits(File, _React$Component11);
	
		function File(props) {
			_classCallCheck(this, File);
	
			var _this12 = _possibleConstructorReturn(this, Object.getPrototypeOf(File).call(this, props));
	
			_this12.state = {
				readonly: _this12.props.readonly
			};
	
			_this12.editMode = _this12.editMode.bind(_this12);
			_this12.restart = _this12.restart.bind(_this12);
			_this12.readOnlyMode = _this12.readOnlyMode.bind(_this12);
			_this12.validation = _this12.validation.bind(_this12);
			return _this12;
		}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'li',
							null,
							'The thesis file must be a PDF or ZIP. '
						),
						_react2.default.createElement(
							'li',
							null,
							'Include all supplementary materials, including data and appendices.'
						),
						_react2.default.createElement(
							'li',
							null,
							'Name files appropriately for public view.'
						)
					),
					_react2.default.createElement(FileControl, { help: '', xpath: this.props.xpath, readonly: this.state.readonly, ref: 'file_control', thesisType: 'openAccess', onUpdate: this.props.onUpdate })
				);
			}
		}]);
	...
	var RadioButton = function (_React$Component12) {
		_inherits(RadioButton, _React$Component12);
	
		function RadioButton(props) {
			_classCallCheck(this, RadioButton);
	
			var _this13 = _possibleConstructorReturn(this, Object.getPrototypeOf(RadioButton).call(this, props));
	
			_this13.state = {
				value: _this13.props.default_value ? _this13.props.default_value : '',
				readonly: _this13.props.readonly,
				error: false
			};
	
			_this13.editMode = _this13.editMode.bind(_this13);
			_this13.restart = _this13.restart.bind(_this13);
			_this13.readOnlyMode = _this13.readOnlyMode.bind(_this13);
			_this13.validation = _this13.validation.bind(_this13);
		...
		_createClass(RadioButton, [{
			...
			value: function render() {
				var error = this.state.error ? _react2.default.createElement(
					'div',
					{ className: 'alert alert-danger', role: 'alert', id: 'radiobutton_error' },
					_react2.default.createElement(
						'button',
						{ type: 'button', className: 'close', 'data-dismiss': 'alert', 'aria-label': 'Close' },
						_react2.default.createElement(
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'label',
							null,
							_react2.default.createElement('input', { type: 'radio', checked: this.state.value == "version of record" ? true : false, onChange: this.handleChange, value: 'version of record', disabled: this.state.readonly }),
							' My examined thesis is my open access version'
						)
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'label',
							null,
							_react2.default.createElement('input', { type: 'radio', checked: this.state.value == "new version" ? true : false, onChange: this.handleChange, value: 'new version', disabled: this.state.readonly }),
							' My open access version is different from my examined thesis (I have removed third party copyright, confidential, or sensitive material as required)'
						)
					)
				);
			}
	...
	var OpenAccessText = function (_React$Component13) {
		_inherits(OpenAccessText, _React$Component13);
	
		function OpenAccessText() {
			_classCallCheck(this, OpenAccessText);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(OpenAccessText).apply(this, arguments));
		}
	
		_createClass(OpenAccessText, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'p',
						null,
						'If third party copyright permission has not been obtained, please remove all affected figures/text/charts/diagrams etc. from the open access version of your thesis. '
					),
					_react2.default.createElement(
						'ul',
						null,
						_react2.default.createElement(
							'li',
							null,
							'In their place insert a short message: ',
							_react2.default.createElement(
								'i',
								null,
					...
					_react2.default.createElement(
						'p',
						null,
						'Confidential and sensitive information should be excluded from the open access version of your thesis.'
					),
					_react2.default.createElement(
						'h3',
						null,
		...
		return OpenAccessText;
	}(_react2.default.Component);
	
	/******* Release status ******/
	
	
	var ReleaseVersionRadioButton = function (_React$Component14) {
		_inherits(ReleaseVersionRadioButton, _React$Component14);
	
		function ReleaseVersionRadioButton(props) {
			_classCallCheck(this, ReleaseVersionRadioButton);
	
			var _this15 = _possibleConstructorReturn(this, Object.getPrototypeOf(ReleaseVersionRadioButton).call(this, props));
	
			_this15.state = {
				value: _this15.props.default_value ? _this15.props.default_value : '',
				readonly: _this15.props.readonly,
				error: false
			};
	
			_this15.editMode = _this15.editMode.bind(_this15);
			_this15.restart = _this15.restart.bind(_this15);
			_this15.readOnlyMode = _this15.readOnlyMode.bind(_this15);
			_this15.validation = _this15.validation.bind(_this15);
			_this15.handleChange = _this15.handleChange.bind(_this15);
			return _this15;
		}
	
		_createClass(ReleaseVersionRadioButton, [{
			key: 'editMode',
			value: function editMode() {
				this.setState({
					readonly: false,
			...
			value: function render() {
				...
				if (this.state.error) {
					errorMsg = _react2.default.createElement(
						'span',
						{ style: error_style },
						'* Open access or embargo access is required'
					);
				}
				return _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'div',
						{ className: 'radio_button col-md-12' },
						_react2.default.createElement(
							'p',
							null,
							'Release of the open access version of your thesis ',
							_react2.default.createElement(
								'span',
								{ style: error_style },
								'*'
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'label',
								null,
								_react2.default.createElement('input', { type: 'radio', checked: this.state.value == "Open Access" ? true : false, onChange: this.handleChange, value: 'Open Access', disabled: this.state.readonly }),
								' Release immediately'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'label',
								null,
								_react2.default.createElement('input', { type: 'radio', checked: this.state.value == "Restricted Access" ? true : false, onChange: this.handleChange, value: 'Restricted Access', disabled: this.state.readonly }),
								' Request embargo  (released at end of embargo period.)'
							)
						)
					)
				);
		...
		return ReleaseVersionRadioButton;
	}(_react2.default.Component);
	
	var TextInput = function (_React$Component15) {
		_inherits(TextInput, _React$Component15);
	
		function TextInput(props) {
			_classCallCheck(this, TextInput);
	
			var _this16 = _possibleConstructorReturn(this, Object.getPrototypeOf(TextInput).call(this, props));
	
			_this16.state = {
				readonly: _this16.props.readonly,
				value: _this16.props.default_value ? _this16.props.default_value : '',
				error: false,
				errorMsg: _this16.props.errorMsg
			};
	
			_this16.editMode = _this16.editMode.bind(_this16);
			_this16.restart = _this16.restart.bind(_this16);
			_this16.readOnlyMode = _this16.readOnlyMode.bind(_this16);
			_this16.validation = _this16.validation.bind(_this16);
			_this16.handleChange = _this16.handleChange.bind(_this16);
			_this16.handleBlur = _this16.handleBlur.bind(_this16);
		...
		_createClass(TextInput, [{
			...
			value: function render() {
				...
				var input = this.props.type == 'textarea' ? _react2.default.createElement('textarea', { className: 'form-control', name: this.props.name, rows: this.props.rows, placeholder: this.props.placeholder, value: this.state.value, onChange: this.handleChange, ref: 'input', minLength: this.props.minLength ? this.props.minLength : 0, required: this.props.required ? true : false, readOnly: this.state.readonly }) : _react2.default.createElement('input', { type: this.props.type, className: 'form-control', name: this.props.name, placeholder: this.props.placeholder, value: this.state.value, onChange: this.handleChange, ref: 'input', minLength: this.props.minLength ? this.props.minLength : 0, required: this.props.required ? true : false, readOnly: this.state.readonly });
	
				return _react2.default.createElement(
					'div',
					{ className: className, onBlur: this.handleBlur, onFocus: this.handleFocus },
					_react2.default.createElement(
						'div',
						{ className: 'col-md-12' },
						_react2.default.createElement(InputError, { errorMessage: this.state.errorMsg, visible: this.state.error }),
						input
					)
				);
			}
	...
	var Embargo_radio_button = function (_React$Component16) {
		_inherits(Embargo_radio_button, _React$Component16);
	
		function Embargo_radio_button(props) {
			_classCallCheck(this, Embargo_radio_button);
	
			var _this17 = _possibleConstructorReturn(this, Object.getPrototypeOf(Embargo_radio_button).call(this, props));
	
			_this17.state = {
				value: _this17.props.default_value ? _this17.props.default_value : '',
				readonly: _this17.props.readonly,
				error: false
			};
	
			_this17.editMode = _this17.editMode.bind(_this17);
			_this17.restart = _this17.restart.bind(_this17);
			_this17.readOnlyMode = _this17.readOnlyMode.bind(_this17);
			_this17.validation = _this17.validation.bind(_this17);
			_this17.handleChange = _this17.handleChange.bind(_this17);
			return _this17;
		}
	
		_createClass(Embargo_radio_button, [{
			key: 'editMode',
			value: function editMode() {
				this.setState({
					readonly: false,
			...
			value: function render() {
				...
				if (this.state.error) {
					errorMsg = _react2.default.createElement(
						'span',
						{ style: error_style },
						' * Duration of emgargo is required '
					);
				}
				return _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'label',
								null,
								_react2.default.createElement('input', { type: 'radio', checked: this.state.value == "12" ? true : false, onChange: this.handleChange, value: '12', disabled: this.state.readonly }),
								' 12 months'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'label',
								null,
								_react2.default.createElement('input', { type: 'radio', checked: this.state.value == "18" ? true : false, onChange: this.handleChange, value: '18', disabled: this.state.readonly }),
								' 18 months'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'label',
								null,
								_react2.default.createElement('input', { type: 'radio', checked: this.state.value == "24" ? true : false, onChange: this.handleChange, value: '24', disabled: this.state.readonly }),
								' 24 months'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'label',
								null,
								_react2.default.createElement('input', { type: 'radio', checked: this.state.value == "36" ? true : false, onChange: this.handleChange, value: '36', disabled: this.state.readonly }),
								' 36 months'
							)
						)
					)
		...
		return Embargo_radio_button;
	}(_react2.default.Component);
	
	var CheckBox = function (_React$Component17) {
		_inherits(CheckBox, _React$Component17);
	
		function CheckBox(props) {
			_classCallCheck(this, CheckBox);
	
			var _this18 = _possibleConstructorReturn(this, Object.getPrototypeOf(CheckBox).call(this, props));
	
			_this18.state = {
				value: _this18.props.default_value ? _this18.props.default_value : '',
				isChecked: _this18.props.default_value == _this18.props.text_value ? true : false,
				readonly: _this18.props.readonly,
				error: false
			};
	
			_this18.editMode = _this18.editMode.bind(_this18);
			_this18.restart = _this18.restart.bind(_this18);
			_this18.readOnlyMode = _this18.readOnlyMode.bind(_this18);
			_this18.validation = _this18.validation.bind(_this18);
		...
		_createClass(CheckBox, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'col-md-12 checkbox' },
					error,
					_react2.default.createElement(
						'label',
						null,
						_react2.default.createElement('input', { type: 'checkbox', checked: this.state.isChecked, onChange: this.handleClick, disabled: this.state.readonly }),
						' ',
						this.props.text,
						'   '
					)
	...
	var CheckBoxCallBack = function (_React$Component18) {
		_inherits(CheckBoxCallBack, _React$Component18);
	
		function CheckBoxCallBack(props) {
			_classCallCheck(this, CheckBoxCallBack);
	
			var _this19 = _possibleConstructorReturn(this, Object.getPrototypeOf(CheckBoxCallBack).call(this, props));
	
			_this19.state = {
				value: _this19.props.default_value ? _this19.props.default_value : '',
				isChecked: _this19.props.default_value == _this19.props.text_value ? true : false,
				readonly: _this19.props.readonly,
				error: false
			};
	
			_this19.editMode = _this19.editMode.bind(_this19);
			_this19.restart = _this19.restart.bind(_this19);
			_this19.readOnlyMode = _this19.readOnlyMode.bind(_this19);
			_this19.validation = _this19.validation.bind(_this19);
			_this19.handleClick = _this19.handleClick.bind(_this19);
			return _this19;
		}
	
		_createClass(CheckBoxCallBack, [{
			key: 'handleClick',
			value: function handleClick() {
				var value = '';
				var isChecked = !this.state.isChecked;
	...
	var EmbargoExtReason = function (_React$Component19) {
		_inherits(EmbargoExtReason, _React$Component19);
	
		function EmbargoExtReason(props) {
			_classCallCheck(this, EmbargoExtReason);
	
			var _this20 = _possibleConstructorReturn(this, Object.getPrototypeOf(EmbargoExtReason).call(this, props));
	
			_this20.state = {
				readonly: _this20.props.readonly
			};
	
			_this20.editMode = _this20.editMode.bind(_this20);
			_this20.restart = _this20.restart.bind(_this20);
			_this20.readOnlyMode = _this20.readOnlyMode.bind(_this20);
			_this20.validation = _this20.validation.bind(_this20);
			return _this20;
		}
	
		_createClass(EmbargoExtReason, [{
			key: 'validation',
			value: function validation() {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						null,
						'Provide an explanation outlining the reasons for the request to place an additional restriction, of up to 18 months, on your research component beyond the original 3 years.'
					),
					_react2.default.createElement(TextInput, { type: 'textarea', ref: 'embargo_ext_reason', rows: '10', name: 'embargo_ext_reason', default_value: default_embargo_extension_reason, required: this.props.required, readonly: this.state.readonly, errorMsg: 'Embargo extension reason is required' })
				);
			}
		}]);
	
		return EmbargoExtReason;
	}(_react2.default.Component);
	
	var EmbargoExt = function (_React$Component20) {
		_inherits(EmbargoExt, _React$Component20);
	
		function EmbargoExt(props) {
			_classCallCheck(this, EmbargoExt);
	
			var _this21 = _possibleConstructorReturn(this, Object.getPrototypeOf(EmbargoExt).call(this, props));
	
			_this21.state = {
				value: _this21.props.default_value ? _this21.props.default_value : '',
				readonly: _this21.props.readonly,
				error: false
			};
	
			_this21.editMode = _this21.editMode.bind(_this21);
			_this21.restart = _this21.restart.bind(_this21);
			_this21.readOnlyMode = _this21.readOnlyMode.bind(_this21);
			_this21.validation = _this21.validation.bind(_this21);
			_this21.getCheckBoxValue = _this21.getCheckBoxValue.bind(_this21);
			return _this21;
		}
	
		_createClass(EmbargoExt, [{
			key: 'getCheckBoxValue',
			value: function getCheckBoxValue(e) {
				this.setState({
					value: e.value
				});
			}
			...
			key: 'render',
			value: function render() {
				var embargoExtReason = this.state.value == 'Additional Restriction' ? _react2.default.createElement(EmbargoExtReason, { readonly: this.state.readonly, ref: 'embargo_ext_resaon', required: true }) : '';
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						null,
						'The Deputy Vice-Chancellor (Academic) (or nominee) may approve an application from an author to restrict access to his or her thesis for a period of up to an additional 18 months beyond the original 3-year embargo from the acceptance of the award of the degree. In exceptional circumstances, longer periods of restriction or a total embargo may be approved by the Deputy Vice-Chancellor (Academic) (or nominee).'
					),
					_react2.default.createElement(
						'h3',
						null,
					...
					_react2.default.createElement(CheckBoxCallBack, { text_value: 'Additional Restriction', default_value: this.props.default_value, readonly: this.state.readonly, text: 'Request to extend embargo access to your thesis for an additional 18 months beyond the original 3 years.', ref: 'embargo_ext', checkedValue: this.getCheckBoxValue }),
					_react2.default.createElement(
						'div',
						{ className: 'col-md-12 ext_reason_area' },
						embargoExtReason
					)
				);
			}
	...
	var Embargo = function (_React$Component21) {
		_inherits(Embargo, _React$Component21);
	
		function Embargo(props) {
			_classCallCheck(this, Embargo);
	
			var _this22 = _possibleConstructorReturn(this, Object.getPrototypeOf(Embargo).call(this, props));
	
			_this22.state = {
				radio_button_value: _this22.props.default_value ? _this22.props.default_value : '',
				embargo_ext_request: _this22.props.default_embargo_ext_request_value ? _this22.props.default_embargo_ext_request_value : '',
				readonly: _this22.props.readonly,
				error: false
			};
	
			_this22.editMode = _this22.editMode.bind(_this22);
			_this22.restart = _this22.restart.bind(_this22);
			_this22.readOnlyMode = _this22.readOnlyMode.bind(_this22);
			_this22.validation = _this22.validation.bind(_this22);
			_this22.handleRadioButtonValue = _this22.handleRadioButtonValue.bind(_this22);
			_this22.handleEmbargoExtRequest = _this22.handleEmbargoExtRequest.bind(_this22);
			_this22.handleTextAreaChange = _this22.handleTextAreaChange.bind(_this22);
	
			return _this22;
		}
	
		_createClass(Embargo, [{
			key: 'handleRadioButtonValue',
			value: function handleRadioButtonValue(e) {
				this.setState({
			...
			key: 'handleEmbargoExtRequest',
			value: function handleEmbargoExtRequest(e) {
				this.setState({
			...
			value: function render() {
				...
				if (this.state.radio_button_value == '36' || this.state.radio_button_value == 36) {
					embargo_ext_request = _react2.default.createElement(EmbargoExt, { readonly: this.state.readonly, ref: 'embargo_ext', default_value: this.props.default_embargo_ext_request_value });
				}
	
				return _react2.default.createElement(
					'div',
					{ className: 'embargo_area' },
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(
						...
						_react2.default.createElement(
							'p',
							null,
							'It is mandatory to submit your examined thesis even if you have requested any embargo. You must also designate an open access version (you may select the examined thesis as your open access version). The open access version of your thesis will not be released openly until after the agreed embargo period has passed.'
						),
						_react2.default.createElement(Embargo_radio_button, { default_value: this.props.default_value, readonly: this.state.readonly, handleClick: this.handleRadioButtonValue, ref: 'radio_button', required: true })
					),
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						...
						_react2.default.createElement(
							'p',
							null,
							'Provide an explanation detailing the reason for the request to place an embargo on your thesis. Please Note this request will be considered by the Deputy Vice-Chancellor Academic. Please make sure that you provide sufficient detail to justify your request.'
						),
						_react2.default.createElement(TextInput, { type: 'textarea', ref: 'embargo_reason', label: '', rows: '10', name: 'embargo_reason', default_value: this.props.embargo_standard_request_reason, required: true, readonly: this.state.readonly, errorMsg: 'Embargo reason is required' })
					),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'p',
							null,
							'Embargo requests will be considered by the Deputy Vice-Chancellor (Academic) (or nominee) only on the grounds'
						),
						_react2.default.createElement(
							'ul',
							{ className: 'embargo_ul' },
							_react2.default.createElement(
								'li',
								null,
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(CheckBox, { text_value: 'Yes', default_value: default_embargo, readonly: this.state.readonly, text: 'I understand, if this embargo is approved, the full text of the thesis will be unavailable until the embargo period passes. I acknowledge that information about this thesis (including abstract) will be made openly available immediately.', ref: 'embargo_statement', errorMsg: 'embargo statement required', required: true })
					)
				);
			}
		}]);
	...
	var OpenAccessForm = function (_React$Component22) {
		_inherits(OpenAccessForm, _React$Component22);
	
		function OpenAccessForm(props) {
			_classCallCheck(this, OpenAccessForm);
	
			var _this23 = _possibleConstructorReturn(this, Object.getPrototypeOf(OpenAccessForm).call(this, props));
	
			_this23.state = {
				radio_button_value: _this23.props.default_open_access_value,
				release_status: _this23.props.default_release_status,
				embargo_radio_button_value: _this23.props.default_embargo_radio_button_value ? _this23.props.default_embargo_radio_button_value : '',
				copyright_statement: _this23.props.default_copyright_value,
				readonly: _this23.props.readonly,
				loading: false,
				error: false,
				valid: false,
			...
			_this23.handleEditClick = _this23.handleEditClick.bind(_this23);
			_this23.handleCancelClick = _this23.handleCancelClick.bind(_this23);
			_this23.handleResetClick = _this23.handleResetClick.bind(_this23);
			_this23.setReleaseStatus = _this23.setReleaseStatus.bind(_this23);
			_this23.setCopyrightValue = _this23.setCopyrightValue.bind(_this23);
			_this23.validation = _this23.validation.bind(_this23);
			_this23.onThesisUpdate = _this23.onThesisUpdate.bind(_this23);
			_this23.handleOpenAccessClick = _this23.handleOpenAccessClick.bind(_this23);
			_this23.handleClick = _this23.handleClick.bind(_this23);
			_this23.handleEmbargoRadioButtonValue = _this23.handleEmbargoRadioButtonValue.bind(_this23);
			_this23.handleSubmitClick = _this23.handleSubmitClick.bind(_this23);
			return _this23;
		}
	
		_createClass(OpenAccessForm, [{
			key: 'handleEditClick',
			...
			key: 'setReleaseStatus',
			value: function setReleaseStatus(e) {
			...
			key: 'setCopyrightValue',
			value: function setCopyrightValue(e) {
				this.setState({
			...
			key: 'handleOpenAccessClick',
			value: function handleOpenAccessClick(e) {
				//for open access radio button click
				this.setState({ radio_button_value: e.value });
			}
		}, {
			key: 'handleClick',
			value: function handleClick(e) {
				//for release status radio button click
				this.setState({ release_status: e.value });
			}
		}, {
			key: 'handleEmbargoRadioButtonValue',
			value: function handleEmbargoRadioButtonValue(e) // for embargo duration radio button click
			{
				this.setState({
			...
			value: function render() {
				...
				var thesisForm = this.state.radio_button_value == "new version" ? _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(OpenAccessText, null),
					_react2.default.createElement(File, { readonly: this.state.readonly, ref: 'openAccessForm', onUpdate: this.onThesisUpdate, xpath: this.props.xpath })
				) : _react2.default.createElement('div', null);
				...
				if (this.props.status == 'draft') {
					if (!this.state.onThesisUpdate) {
						if (this.state.readonly) {
							button = _react2.default.createElement(
								'div',
								null,
								_react2.default.createElement(Button, { buttonClick: this.handleEditClick, text: 'Edit Step 3' }),
							...
							if (this.props.newThesis == false) {
								button = _react2.default.createElement(
									'div',
									null,
									_react2.default.createElement(Button, { buttonClick: this.handleSubmitClick, text: 'Save Step 3' }),
									'    ',
									_react2.default.createElement(Button, { buttonClick: this.handleCancelClick, text: 'Cancel Edit' }),
									_react2.default.createElement('hr', null)
								);
							}
						}
					...
					var submitButton = this.state.readonly ? _react2.default.createElement('div', null) : _react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement('hr', null),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'button',
								{ className: 'btn btn-primary save', type: 'submit' },
								txt
							)
						),
						' ',
				...
				var embargo = '';
				if (this.state.release_status == 'Restricted Access') {
					embargo = _react2.default.createElement(Embargo, { default_value: this.props.default_embargo_radio_button_value,
				...
				return _react2.default.createElement(
					'form',
					{ role: 'form', className: 'thesisForm form-horizontal', encType: 'multipart/form-data', onSubmit: this.handleSubmitClick, noValidate: true },
					loading,
					error,
					_react2.default.createElement(
						'div',
						{ className: 'col-md-12 open_access_form' },
						_react2.default.createElement(
							'div',
							{ className: className },
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'p',
									null,
									'Third party copyright is any copyrighted material in your thesis that you have not created and does not belong to you. It is any material in your thesis for which you are not the copyright owner. It can include diagrams, images, tables, figures, text, film etc. Permission is required to use \'third party copyright material\'. For more information see: ',
									_react2.default.createElement(
										'a',
										{ href: 'http://www.flinders.edu.au/library/copyright', target: '_blank' },
								...
								_react2.default.createElement(
									'p',
									null,
									'You can request an embargo period for release of the open access version'
								)
							),
							_react2.default.createElement(
								'div',
								{ classNmae: 'row' },
								_react2.default.createElement(RadioButton, { readonly: this.state.readonly, handleClick: this.handleOpenAccessClick, value: this.state.radio_button_value, default_value: this.props.default_open_access_value, ref: 'radioButton', required: true, errorMsg: 'required' }),
								thesisForm
							),
							_react2.default.createElement(
								'div',
								...
								_react2.default.createElement(
									'p',
									null,
									'I confirm that the open access version of my thesis does not infringe the intellectual property rights of a third party OR that all parties with a claim to intellectual property contained in any content in my thesis have agreed to the deposit of my thesis in the Flinders University Theses Collection and dissemination online.'
								),
								_react2.default.createElement(
									'p',
									null,
									'I confirm that the open access version of my thesis does not contain confidential information OR that I have obtained permission from the authorised party to make the confidential information public.'
								),
								_react2.default.createElement(
									'p',
									null,
									'I hereby grant to the Flinders University or its agents the right to archive and to make available my thesis or dissertation in whole or in part, in all forms of media, now or hereafter known. I retain all proprietary rights, such as patent rights. I also retain the right to use in future works (such as articles or books) all or part of this thesis or dissertation.'
								),
								_react2.default.createElement(CheckBoxCallBack, { text_value: 'Yes', default_value: this.props.default_copyright_value, readonly: this.state.readonly, text: 'I agree', ref: 'copyright', errorMsg: 'Copyright Statement required', required: true, checkedValue: this.setCopyrightValue })
							),
							_react2.default.createElement('hr', null),
							_react2.default.createElement(
								'h3',
								null,
								'Public Release of your Thesis'
							),
							_react2.default.createElement(
								'p',
								null,
								'Candidates may make a request to the Deputy Vice-Chancellor (Academic) (or nominee) to place a restriction on the access to their thesis in accordance with clause 14 of ',
								_react2.default.createElement(
									'a',
									{ href: 'http://www.flinders.edu.au/ppmanual/student/research-components-of-postgraduate-coursework-awards.cfm', target: '_blank' },
									' Research Components of Postgraduate Coursework Awards '
								),
								'.'
							),
							_react2.default.createElement(ReleaseVersionRadioButton, { default_value: this.props.default_release_status, readonly: this.state.readonly, handleClick: this.setReleaseStatus, required: true, ref: 'releaseVersionRadioButton' }),
							embargo,
							submitButton
						)
					)
		...
		return OpenAccessForm;
	}(_react2.default.Component);
	
	_reactDom2.default.render(_react2.default.createElement(OpenAccessForm, { readonly: readonly, newThesis: newThesis, default_release_status: default_release_status, default_embargo_radio_button_value: default_embargo_radio_button_value, embargo_standard_request_reason: embargo_standard_request_reason, status: status, default_open_access_value: default_open_access_value, default_copyright_value: default_copyright_value, xpath: '/xml/item/curriculum/thesis/version/open_access/files' }), document.getElementById('content'));
