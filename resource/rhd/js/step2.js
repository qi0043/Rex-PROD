...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileUploader = function (_React$Component6) {
	    _inherits(FileUploader, _React$Component6);
	    ...
	    function FileUploader(props) {
	        ...
	        _this6.state = {
	            readonly: _this6.props.readonly,
	            attachment: '',
	            help: _this6.props.help,
	            error: false,
	            errorMsg: ''
	        };
	        _this6.restart = _this6.restart.bind(_this6);
	        _this6.editMode = _this6.editMode.bind(_this6);
	        _this6.readOnlyMode = _this6.readOnlyMode.bind(_this6);
	        _this6.fileUpload = _this6.fileUpload.bind(_this6);
	        _this6.validation = _this6.validation.bind(_this6);
	        _this6.editHelpMsg = _this6.editHelpMsg.bind(_this6);
	        return _this6;
	    }
	...
	var DefaultFile = function (_React$Component7) {
	    _inherits(DefaultFile, _React$Component7);
	
	    function DefaultFile(props) {
	        _classCallCheck(this, DefaultFile);
	
	        var _this8 = _possibleConstructorReturn(this, Object.getPrototypeOf(DefaultFile).call(this, props));
	
	        var text = '';
	        if (_this8.props.default_file_name != '') {
	            var str = 'File: ' + _this8.props.default_file_name + ' uploaded.';
	            var size = ' - file size: ' + formatBytes(_this8.props.default_file_size);
	...
	var FileWrapper = function (_React$Component8) {
	    _inherits(FileWrapper, _React$Component8);
	
	    function FileWrapper(props) {
	        _classCallCheck(this, FileWrapper);
	
	        var _this9 = _possibleConstructorReturn(this, Object.getPrototypeOf(FileWrapper).call(this, props));
	
	        _this9.state = {
	            visible: true,
	            count: _this9.props.count,
	            readonly: _this9.props.readonly,
	            default_file: _this9.props.default_file_name ? true : false,
	            uuid: _this9.props.uuid ? _this9.props.uuid : ''
	        };
	        ...
	        _this9.removeClickHandler = _this9.removeClickHandler.bind(_this9);
	        _this9.undoClickHandler = _this9.undoClickHandler.bind(_this9);
	...
	var FileControl = function (_React$Component9) {
	    _inherits(FileControl, _React$Component9);
	
	    function FileControl(props) {
	        _classCallCheck(this, FileControl);
	
	        var _this10 = _possibleConstructorReturn(this, Object.getPrototypeOf(FileControl).call(this, props));
	
	        if (_this10.props.thesisType == 'examined') {
	            if (examinedTheses.length > 0) {
	                for (var i = 0; i < examinedTheses.length; i++) {
	                    examinedTheses[i].readonly = _this10.props.readonly;
	                    examinedTheses[i].help = _this10.props.help;
	                }
	                _this10.state = {
	                ...
	                temp["readonly"] = _this10.props.readonly;
	                temp["help"] = _this10.props.help;
	                items.push(temp);
	                _this10.state = {
	                    loading: false,
	                    readonly: _this10.props.readonly,
	        ...
	        } else if (_this10.props.thesisType == 'openAccess') {
	            if (openAccessTheses.length > 0) {
	                for (var i = 0; i < openAccessTheses.length; i++) {
	                    openAccessTheses[i].readonly = _this10.props.readonly;
	                    openAccessTheses[i].help = _this10.props.help;
	                }
	                _this10.state = {
	                    readonly: _this10.props.readonly,
	                    error: false,
	        ...
	        _this10.handleResetClick = _this10.handleResetClick.bind(_this10);
	        _this10.readOnlyMode = _this10.readOnlyMode.bind(_this10);
	        _this10.restart = _this10.restart.bind(_this10);
	        _this10.handleAddClick = _this10.handleAddClick.bind(_this10);
	...
	var CheckBox = function (_React$Component10) {
	    ...
	    function CheckBox(props) {
	        ...
	        var _this11 = _possibleConstructorReturn(this, Object.getPrototypeOf(CheckBox).call(this, props));
	
	        _this11.state = {
	            value: _this11.props.default_value ? _this11.props.default_value : '',
	            isChecked: _this11.props.default_value == _this11.props.text_value ? true : false,
	...
	var Declaration = function (_React$Component11) {
	    _inherits(Declaration, _React$Component11);
	
	    function Declaration(props) {
	        _classCallCheck(this, Declaration);
	
	        var _this12 = _possibleConstructorReturn(this, Object.getPrototypeOf(Declaration).call(this, props));
	
	        _this12.state = {
	            readonly: _this12.props.readonly,
	            error: false
	        };
	        _this12.handleEditClick = _this12.handleEditClick.bind(_this12);
	        _this12.handleCancelClick = _this12.handleCancelClick.bind(_this12);
	    ...
	    _createClass(Declaration, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'declaration col-md-12' },
	                    _react2.default.createElement(
	                        'h3',
	                        null,
	                    ...
	                    _react2.default.createElement(
	                        'p',
	                        null,
	                        'I certify that this thesis has been approved by the University for the research component of the postgraduate coursework award. I acknowledge that this authoritative thesis may contain third party copyright material and this copy will be archived and will not be publicly accessible.'
	                    ),
	                    _react2.default.createElement(CheckBox, { text_value: 'I agree', default_value: authenticity, readonly: this.state.readonly, text: 'I agree', ref: 'authenticity', errorMsg: 'Authenticity required', required: true })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'declaration col-md-12' },
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'a',
	                            { href: 'http://www.flinders.edu.au/ppmanual/student/research-higher-degrees.cfm#AppendixF', target: '_blank' },
	                            'Appendix F: Rules for Higher Degree Theses '
	                        ),
	                        'Clause 6 (d) I certify that this thesis does not incorporate without acknowledgment any material previously submitted for a degree or diploma in any university; and that to the best of my knowledge and belief it does not contain any material previously published or written by another person except where due reference is made in the text.'
	                    ),
	                    _react2.default.createElement(CheckBox, { text_value: 'Yes', default_value: declaration, readonly: this.state.readonly, text: 'I agree', ref: 'declaration', errorMsg: 'Declaration required', required: true })
	                )
	            );
	        }
	    }]);
	...
	var ExaminedForm = function (_React$Component12) {
	    _inherits(ExaminedForm, _React$Component12);
	
	    function ExaminedForm(props) {
	        _classCallCheck(this, ExaminedForm);
	
	        var _this13 = _possibleConstructorReturn(this, Object.getPrototypeOf(ExaminedForm).call(this, props));
	        ...
	        _this13.handleEditClick = _this13.handleEditClick.bind(_this13);
	        _this13.handleCancelClick = _this13.handleCancelClick.bind(_this13);
	        _this13.restart = _this13.restart.bind(_this13);
	        _this13.handleResetClick = _this13.handleResetClick.bind(_this13);
	        _this13.onThesisUpdate = _this13.onThesisUpdate.bind(_this13);
	        _this13.handleSubmit = _this13.handleSubmit.bind(_this13);
	        return _this13;
	    }
	
	    _createClass(ExaminedForm, [{
	        key: 'handleEditClick',
	        value: function handleEditClick() {
	            this.setState({
	                readonly: false,
	            ...
	            if (valid) {
	                ...
	                for (var ref in file_control.refs) {
	                    ...
	                    if (i.state.visible && i.state.default_file) {
	                        ...
	                        if (file_uploader.state.attachment != "") {
	                            var file = file_uploader.state.attachment;
	                            console.log('file_name(s): ' + file.name);
	                            formData.append('attachments[]', JSON.stringify({ 'uuid': '', 'file_name': file.name, 'file_size': file.size }));
	                            formData.append('thesis_file[]', file, file.name);
	                        }
	                    }
	        ...
	        value: function render() {
	            ...
	            var fileControl = _react2.default.createElement(FileControl, { help: '', xpath: this.props.xpath, readonly: this.state.readonly, ref: 'file_control', thesisType: 'examined', onUpdate: this.onThesisUpdate });
	            var loading = this.state.loading ? _react2.default.createElement(
	                'div',
	                { className: 'spinner-wave', style: spinner_wave_style },
	                _react2.default.createElement('div', { style: spinner_style }),
	            ...
	            if (this.props.status == 'draft') {
	                if (!this.state.onThesisUpdate) {
	                    if (this.state.readonly) {
	                        button = _react2.default.createElement(
	                            'div',
	                            null,
	                            _react2.default.createElement(Button, { buttonClick: this.handleEditClick, text: 'Edit Step 2' }),
	                        ...
	                        if (!this.props.newThesis) {
	                            button = _react2.default.createElement(
	                                'div',
	                                null,
	                                _react2.default.createElement(Button, { buttonClick: this.handleSubmit, text: 'Save Step 2' }),
	                                '    ',
	                ...
	                submitButton = this.state.readonly && this.props.status == 'draft' ? _react2.default.createElement('div', null) : _react2.default.createElement(
	                    'div',
	                    { className: 'row' },
	                    _react2.default.createElement('hr', null),
	                    _react2.default.createElement(
	            ...
	            return _react2.default.createElement(
	                'form',
	                { role: 'form', className: 'thesisForm form-horizontal', encType: 'multipart/form-data', noValidate: true },
	                loading,
	                error,
	                _react2.default.createElement(
	                    'div',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'li',
	                                    null,
	                                    'The thesis file must be a PDF. '
	                                ),
	                                _react2.default.createElement(
	                                    'li',
	                                    null,
	                                    'Include any supplementary files, used in the examination process (must be a PDF or ZIP file).'
	                                ),
	                                _react2.default.createElement(
	                                    'li',
	                                    null,
	                            ...
	                            fileControl,
	                            _react2.default.createElement('hr', null),
	                            _react2.default.createElement(Declaration, { readonly: this.state.readonly, newThesis: this.props.newThesis, ref: 'declaration', status: this.props.status })
	                        )
	                    ),
	                    submitButton
	                )
	...
	_reactDom2.default.render(_react2.default.createElement(ExaminedForm, { readonly: readonly, newThesis: new_thesis, status: status, xpath: '/xml/item/curriculum/thesis/version/examined_thesis/files' }), document.getElementById('content'));
