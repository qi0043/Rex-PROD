...
/***/ function(module, exports, __webpack_require__) {
	...
	var MinusButton = function (_React$Component3) {
		_inherits(MinusButton, _React$Component3);
	...
	var UndoButton = function (_React$Component6) {
		_inherits(UndoButton, _React$Component6);
	...
	var SelectList = function (_React$Component7) {
		_inherits(SelectList, _React$Component7);
	
		function SelectList(props) {
			_classCallCheck(this, SelectList);
	
			var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(SelectList).call(this, props));
	
			var items = _this7.props.data;
			for (var i = 0; i < items.length; i++) {
				items[i].disabled = _this7.props.readonly ? true : false;
			}
			_this7.state = {
				readonly: _this7.props.readonly ? true : false,
				value: _this7.props.default_value ? _this7.props.default_value : '',
				error: false,
				items: _this7.props.data ? _this7.props.data : []
			};
		...
		_createClass(SelectList, [{
			...
			value: function render() {
				...
				var label = this.props.required ? _react2.default.createElement(
					'label',
					{ htmlFor: this.props.name, className: 'control-label col-sm-2' },
					this.props.label,
					' ',
					_react2.default.createElement(
						'span',
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'select',
							{ className: 'form-control', value: this.state.value, defaultValue: this.props.default_value, name: this.props.name, onChange: this.handleChange, ref: 'selectList', required: this.props.required ? true : false, disabled: this.state.readonly },
							this.state.items.map(function (i) {
								return _react2.default.createElement(
									'option',
									{ key: i.value, value: i.value, disabled: i.disabled },
									i.text
								);
							})
						),
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement(InputError, { visible: this.state.error, errorMessage: this.props.emptyMessage })
						)
					)
				);
			}
	...
	var SchoolSelector = function (_React$Component8) {
		_inherits(SchoolSelector, _React$Component8);
	
		function SchoolSelector(props) {
			_classCallCheck(this, SchoolSelector);
	
			var _this8 = _possibleConstructorReturn(this, Object.getPrototypeOf(SchoolSelector).call(this, props));
	
			var items = _this8.props.data;
			for (var i = 0; i < items.length; i++) {
				items[i].disabled = _this8.props.readonly ? true : false;
			}
			_this8.state = {
				readonly: true,
				value: _this8.props.default_value ? _this8.props.default_value : '',
				error: false,
				items: _this8.props.data ? _this8.props.data : []
			};
	
			_this8.restart = _this8.restart.bind(_this8);
			_this8.editMode = _this8.editMode.bind(_this8);
			_this8.readOnlyMode = _this8.readOnlyMode.bind(_this8);
			_this8.validation = _this8.validation.bind(_this8);
	...
	var TextInput = function (_React$Component9) {
		_inherits(TextInput, _React$Component9);
	
		function TextInput(props) {
			_classCallCheck(this, TextInput);
	
			var _this9 = _possibleConstructorReturn(this, Object.getPrototypeOf(TextInput).call(this, props));
	
			var default_value = '';
			if (_this9.props.default_value != '') {
				default_value = _this9.props.default_value;
			}
			_this9.state = {
				readonly: _this9.props.readonly,
				value: default_value,
				error: false,
				errorMsg: _this9.props.errorMessage ? _this9.props.errorMessage : ''
			};
			_this9.restart = _this9.restart.bind(_this9);
			_this9.editMode = _this9.editMode.bind(_this9);
			_this9.readOnlyMode = _this9.readOnlyMode.bind(_this9);
			_this9.validation = _this9.validation.bind(_this9);
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						{ className: 'col-sm-10' },
						input,
						_react2.default.createElement(InputError, { visible: this.state.error, errorMessage: this.state.errorMsg })
					)
				);
			}
		}]);
	...
	var StudentID = function (_React$Component10) {
		_inherits(StudentID, _React$Component10);
	
		function StudentID(props) {
			_classCallCheck(this, StudentID);
	
			var _this10 = _possibleConstructorReturn(this, Object.getPrototypeOf(StudentID).call(this, props));
	
			_this10.state = {
				value: _this10.props.default_value
			};
		...
		_createClass(StudentID, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'label',
						{ htmlFor: 'stu_id', className: 'control-label col-md-2' },
						'Student ID'
					),
					_react2.default.createElement(
						'div',
						{ className: 'col-md-10' },
						_react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'stu_id', value: this.state.value, readOnly: true })
					)
				);
			}
		}]);
	...
	var FileUploader = function (_React$Component11) {
		_inherits(FileUploader, _React$Component11);
	
		function FileUploader(props) {
			_classCallCheck(this, FileUploader);
	
			var _this11 = _possibleConstructorReturn(this, Object.getPrototypeOf(FileUploader).call(this, props));
			...
			_this11.fileUpload = _this11.fileUpload.bind(_this11);
		...
		_createClass(FileUploader, [{
						...
						if (file.size > 0 && file.type != 'application/pdf') {
							...
							_this12.setState({
								help: _react2.default.createElement(
									'div',
									{ style: error_style },
									'[Warning] No File chosen, please upload a pdf file'
								)
							});
						} else {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					null,
					error,
					_react2.default.createElement('input', { type: 'file', className: 'file_upload form-control-file', ref: 'file_attachment', name: 'abstract_files[]', onChange: this.fileUpload, disabled: this.state.readonly }),
					_react2.default.createElement(
						'h5',
	...
	var DefaultFile = function (_React$Component12) {
		_inherits(DefaultFile, _React$Component12);
	
		function DefaultFile(props) {
			_classCallCheck(this, DefaultFile);
	
			var _this13 = _possibleConstructorReturn(this, Object.getPrototypeOf(DefaultFile).call(this, props));
	
			var text = '';
			if (_this13.props.default_file_name != '') {
				var str = 'File: ' + _this13.props.default_file_name + ' uploaded.';
				var size = ' - file size: ' + formatBytes(_this13.props.default_file_size);
	...
	var File = function (_React$Component13) {
		_inherits(File, _React$Component13);
	
		function File(props) {
			_classCallCheck(this, File);
	
			var _this14 = _possibleConstructorReturn(this, Object.getPrototypeOf(File).call(this, props));
	
			_this14.state = {
				readonly: _this14.props.readonly,
				visible: _this14.props.visible
			};
			_this14.restart = _this14.restart.bind(_this14);
			_this14.editMode = _this14.editMode.bind(_this14);
			_this14.readOnlyMode = _this14.readOnlyMode.bind(_this14);
			_this14.extra_remove_button_handler = _this14.extra_remove_button_handler.bind(_this14);
			_this14.validation = _this14.validation.bind(_this14);
			return _this14;
		}
		...
		_createClass(File, [{
			...
			key: 'extra_remove_button_handler',
			value: function extra_remove_button_handler() {
				this.setState({
					visible: false
				});
			}
			...
			key: 'render',
			value: function render() {
				var undo_button = this.props.default_file_name != '' ? _react2.default.createElement(UndoButton, { clickHandler: this.props.undoClickHandler }) : _react2.default.createElement('div', null);
				var remove_button = this.state.readonly ? '' : _react2.default.createElement(RemoveButton, { clickHandler: this.props.clickHandler });
				var file = this.state.visible ? _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-10' },
							_react2.default.createElement(DefaultFile, { default_file_name: this.props.default_file_name, default_file_size: this.props.default_file_size, file_link: this.props.file_link, help: this.props.help, readonly: this.state.readonly })
						),
						' ',
						remove_button,
						' '
	...
	var TopicControl = function (_React$Component14) {
		_inherits(TopicControl, _React$Component14);
	
		function TopicControl(props) {
			_classCallCheck(this, TopicControl);
	
			var _this15 = _possibleConstructorReturn(this, Object.getPrototypeOf(TopicControl).call(this, props));
	
			_this15.state = {
				readonly: _this15.props.readonly,
				topic_code: _this15.props.default_topic_code ? _this15.props.default_topic_code : '',
				topic_name: _this15.props.default_topic_name ? _this15.props.default_topic_name : '',
				topic_code_error: false,
				topic_code_errorMsg: '',
				topic_name_disable: true,
				btn_select_disable: _this15.props.readonly ? true : false
			};
			...
			_this15.getTopicInfoFromServer = _this15.getTopicInfoFromServer.bind(_this15);
			_this15.handleChange = _this15.handleChange.bind(_this15);
			_this15.handleNameChange = _this15.handleNameChange.bind(_this15);
			_this15.setError = _this15.setError.bind(_this15);
			_this15.handleEnterPress = _this15.handleEnterPress.bind(_this15);
			return _this15;
		}
	
		_createClass(TopicControl, [{
			key: 'restart',
			value: function restart() {
				this.setState({
					readonly: this.props.readonly,
			...
			key: 'getTopicInfoFromServer',
			value: function getTopicInfoFromServer() {
	            ...
	            var topic_url = 'https://flextra.flinders.edu.au/flex/rhd/coursework/getTopicInfo';
				$.ajax({
					url: topic_url,
					method: "POST",
			...
			value: function render() {
				...
				var label = this.props.required ? _react2.default.createElement(
					'label',
					{ htmlFor: 'topic_code', className: 'control-label col-sm-2' },
					'Topic Code: ',
					_react2.default.createElement(
						'span',
						{ style: error_style },
				...
				var button = this.state.btn_select_disable ? _react2.default.createElement(
					'button',
					{ className: 'btn btn-default', type: 'button', disabled: true },
					'Confirm'
				) : _react2.default.createElement(
					'button',
					{ className: 'btn btn-primary', type: 'button', onClick: this.getTopicInfoFromServer },
					'Confirm'
				);
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-8' },
							_react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'topic_code', value: this.state.topic_code, onChange: this.handleChange, ref: 'topic_code', required: this.props.required ? true : false, disabled: this.state.readonly, onKeyDown: this.handleEnterPress }),
							_react2.default.createElement(InputError, { visible: this.state.topic_code_error, errorMessage: this.state.topic_code_errorMsg })
						),
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-2' },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'label',
							{ htmlFor: 'topic_name', className: 'control-label col-sm-2' },
							'Topic Name: '
						),
						_react2.default.createElement(
							'div',
							{ className: 'col-sm-10' },
							_react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'topic_name', value: this.state.topic_name, onChange: this.handleNameChange, ref: 'topic_name', required: this.props.required ? true : false, disabled: this.state.topic_name_disable })
						)
					)
				);
			}
	...
	var TopicControlWrapper = function (_React$Component15) {
		_inherits(TopicControlWrapper, _React$Component15);
	
		function TopicControlWrapper(props) {
			_classCallCheck(this, TopicControlWrapper);
	
			var _this16 = _possibleConstructorReturn(this, Object.getPrototypeOf(TopicControlWrapper).call(this, props));
	
			_this16.state = {
				readonly: _this16.props.readonly,
				visible: true,
				count: _this16.props.count,
				error: false,
				errorMsg: '',
				org_num: _this16.props.org_num
			};
			_this16.clickHandler = _this16.clickHandler.bind(_this16);
			_this16.setError = _this16.setError.bind(_this16);
			_this16.setSchool = _this16.setSchool.bind(_this16);
		...
		_createClass(TopicControlWrapper, [{
			key: 'clickHandler',
			...
			value: function render() {
				var error = this.state.error ? _react2.default.createElement(
					'div',
					{ className: 'alert alert-danger', role: 'alert', id: 'app_error' },
					_react2.default.createElement(
						'button',
						{ type: 'button', className: 'close', 'data-dismiss': 'alert', 'aria-label': 'Close' },
						_react2.default.createElement(
				...
				var topicControl = this.state.visible ? _react2.default.createElement(TopicControl, { ref: 'topicControl', default_topic_code: this.props.default_topic_code, default_topic_name: this.props.default_topic_name, readonly: this.state.readonly, setSchool: this.setSchool, setError: this.setError }) : '';
				var button = this.state.visible && !this.state.readonly && this.state.count > 1 ? _react2.default.createElement(MinusButton, { clickHandler: this.clickHandler }) : '';
		...
		return TopicControlWrapper;
	}(_react2.default.Component);
	
	var Topic = function (_React$Component16) {
		_inherits(Topic, _React$Component16);
	
		function Topic(props) {
			_classCallCheck(this, Topic);
	
			var _this17 = _possibleConstructorReturn(this, Object.getPrototypeOf(Topic).call(this, props));
	
			if (topics.length > 0) {
				for (var i = 0; i < topics.length; i++) {
					topics[i].readonly = _this17.props.readonly;
				}
				...
				temp["readonly"] = _this17.props.readonly;
				items.push(temp);
				...
				for (var ref in _this17.refs) {
					var i = _this17.refs[ref];
					i.restart();
				}
			...
			_this17.handleAddClick = _this17.handleAddClick.bind(_this17);
			_this17.updateSchool = _this17.updateSchool.bind(_this17);
			return _this17;
		}
		...
		_createClass(Topic, [{
			...
			value: function render() {
				var items = this.state.items.map(function (i) {
					return _react2.default.createElement(TopicControlWrapper, { ref: i.refname, key: i.item, count: i.item, default_topic_code: i.default_topic_code, default_topic_name: i.default_topic_name, readonly: i.readonly, setSchool: this.updateSchool });
				}.bind(this));
				return _react2.default.createElement(
					'div',
					{ className: 'form-group' },
	...
	var ThesisForm = function (_React$Component17) {
		_inherits(ThesisForm, _React$Component17);
	
		function ThesisForm(props) {
			_classCallCheck(this, ThesisForm);
	
			var _this18 = _possibleConstructorReturn(this, Object.getPrototypeOf(ThesisForm).call(this, props));
			...
			_this18.state = {
				...
				comp_yr: yr,
				items: [],
				default_file: _this18.props.default_file_name != '' ? true : false,
				error: false,
				org_unit: _this18.props.org_unit,
				errorMsg: '',
				newThesis: _this18.props.newThesis,
				uuid: _this18.props.uuid,
				version: _this18.props.version
			};
			_this18.editMode = _this18.editMode.bind(_this18);
			_this18.readOnlyMode = _this18.readOnlyMode.bind(_this18);
			_this18.cancelEdit = _this18.cancelEdit.bind(_this18);
			_this18.updateSchool = _this18.updateSchool.bind(_this18);
			_this18.handleSubmit = _this18.handleSubmit.bind(_this18);
			_this18.handleRemoveClick = _this18.handleRemoveClick.bind(_this18);
			_this18.handleFileControlRestart = _this18.handleFileControlRestart.bind(_this18);
			return _this18;
		}
	
		_createClass(ThesisForm, [{
			key: 'editMode',
			value: function editMode() {
				this.setState({
					readonly: false
								...
								case 'success':
									if (this.state.newThesis) {
										if (this.state.uuid == '') {
											...
											new_url = new_url + uuid + "/" + version + "/15";
										}
										else
										{
											new_url = step2_url_n;
			...
			key: 'handleFileControlRestart',
			value: function handleFileControlRestart() {
				this.setState({
			...
			value: function render() {
					...
					buttons = _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'button',
									{ className: 'btn btn-primary save', type: 'button', onClick: this.handleSubmit },
									'Save and continue'
								)
							),
				...
				if (student_id == '') {
					student_id_component = _react2.default.createElement(TextInput, { ref: 'stu_id', label: 'Student ID', type: 'text', name: 'stu_id', required: true, errorMessage: 'Student ID is invalid', emptyMessage: 'Student ID is required', minLength: 5, default_value: student_id, readonly: this.state.readonly });
				} else {
					student_id_component = _react2.default.createElement(StudentID, { ref: 'stu_id', default_value: student_id });
				}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'form',
						{ role: 'form', className: 'thesisForm form-horizontal', noValidate: true },
						student_id_component,
						_react2.default.createElement(TextInput, { ref: 'stu_pre_first_name', label: 'Preferred First Name Display', type: 'text', name: 'stu_pre_first_name', placeholder: 'This will be used in citations and on the publicly available thesis web page.', default_value: default_stu_first_name_dip, errorMessage: 'Preferred first name is invalid', emptyMessage: 'Preferred first name is required', readonly: this.state.readonly }),
						_react2.default.createElement(TextInput, { ref: 'stu_pre_last_name', label: 'Preferred Last Name Display', type: 'text', name: 'stu_pre_last_name', placeholder: 'This will be used in citations and on the publicly available thesis web page.', default_value: default_stu_last_name_dip, errorMessage: 'Preferred first name is invalid', emptyMessage: 'Preferred first name is required', readonly: this.state.readonly }),
						_react2.default.createElement(TextInput, { ref: 'stu_email', label: 'Preferred Email Contact', type: 'email', name: 'stu_email', required: true, errorMessage: 'Student Email is invalid', emptyMessage: 'Student Email is required', default_value: default_stu_email, readonly: this.state.readonly }),
						_react2.default.createElement(SelectList, { label: 'Thesis Type', name: 'thesis_type', emptyMessage: 'Thesis Type is required', required: true, ref: 'thesis_type', data: thesis_type, default_value: default_coursework_type, readonly: this.state.readonly }),
						_react2.default.createElement(Topic, { readonly: this.state.readonly, ref: 'topic', updateSchool: this.updateSchool }),
						_react2.default.createElement('hr', null),
						_react2.default.createElement(TextInput, { ref: 'comp_yr', label: 'Thesis Completion (year)', name: 'comp_yr', required: true, errorMessage: 'Complete year is invalid', emptyMessage: 'Complete year is required', type: 'year', default_value: this.props.comp_yr, readonly: this.state.readonly }),
						_react2.default.createElement(SchoolSelector, { label: 'School', name: 'school', emptyMessage: 'Please fill in a valid topic code to populate school data', required: true, valid: this.state.items, ref: 'school', data: schools, default_value: this.props.org_unit, readonly: this.state.readonly }),
						_react2.default.createElement(TextInput, { ref: 'sup_name', label: 'Principle Supervisor: Name', type: 'text', name: 'sup_name', uniqueName: 'form-group sup_name', required: true, errorMessage: 'Supervisor name is invalid', emptyMessage: 'Supervisor name is required', default_value: default_coord_name, readonly: this.state.readonly }),
						_react2.default.createElement(TextInput, { ref: 'sup_email', label: 'Principle Supervisor: Email', type: 'email', name: 'sup_email', uniqueName: 'form-group sup_email', errorMessage: 'Supervisor email is invalid', default_value: default_coord_email, readonly: this.state.readonly }),
						_react2.default.createElement('hr', null),
						_react2.default.createElement(TextInput, { type: 'textarea', ref: 'title', label: 'Thesis Title', rows: '5', name: 'thesis_title', required: true, placeholder: '', emptyMessage: 'Thesis title is required', default_value: default_thesis_title, readonly: this.state.readonly }),
						_react2.default.createElement(TextInput, { type: 'textarea', ref: 'abstract', label: 'Abstract', rows: '10', name: 'thesis_abstract', placeholder: '', default_value: default_abstract, readonly: this.state.readonly, required: true }),
						_react2.default.createElement(
							'div',
							{ className: 'form-group abstract' },
							_react2.default.createElement(
								'div',
								{ className: 'col-sm-offset-2 col-sm-10' },
								_react2.default.createElement(
								...
								_react2.default.createElement(File, { className: 'form-control', help: '', ref: 'file_upload', default_file_name: this.props.default_file_name, default_file_size: this.props.default_file_size, file_link: this.props.file_link, clickHandler: this.handleRemoveClick, undoClickHandler: this.handleFileControlRestart, visible: this.state.default_file, readonly: this.state.readonly })
							)
						),
						_react2.default.createElement(TextInput, { type: 'textarea', ref: 'keywords', label: 'Keywords (comma separated)', rows: '5', name: 'keywords', placeholder: '', default_value: default_keywords, required: true, readonly: this.state.readonly }),
						_react2.default.createElement('hr', null),
						buttons
					),
					loading
	...
	var App = function (_React$Component18) {
		...
		function App(props) {
			...
			var _this19 = _possibleConstructorReturn(this, Object.getPrototypeOf(App).call(this, props));
			...
			_this19.handleEditClick = _this19.handleEditClick.bind(_this19);
			_this19.handleCancelClick = _this19.handleCancelClick.bind(_this19);
			_this19.handleSubmitClick = _this19.handleSubmitClick.bind(_this19);
			_this19.onThesisUpdate = _this19.onThesisUpdate.bind(_this19);
			_this19.removeThesisUpdate = _this19.removeThesisUpdate.bind(_this19);
			return _this19;
		}
		...
		_createClass(App, [{
			...
			key: 'removeThesisUpdate',
			value: function removeThesisUpdate() {
				this.setState({
			...
			value: function render() {
				...
				if (!this.state.onThesisUpdate) {
					if (!this.props.newThesis && this.props.status == 'draft') {
						...
						button = this.state.readonly ? _react2.default.createElement(
							'div',
							{ className: 'edit_buttons' },
							_react2.default.createElement(Button, { buttonClick: this.handleEditClick, text: 'Edit Step 1' }),
							_react2.default.createElement('hr', null)
						) : _react2.default.createElement(
							'div',
							{ className: 'edit_buttons' },
							_react2.default.createElement(Button, { className: 'edit_buttons', buttonClick: this.handleSubmitClick, text: 'Save Step 1' }),
							'     ',
							_react2.default.createElement(Button, { className: 'edit_buttons', buttonClick: this.handleCancelClick, text: 'Cancel Edit' }),
							_react2.default.createElement('hr', null)
						);
	...
	_reactDom2.default.render(_react2.default.createElement(App, { newThesis: new_thesis, readonly: read_only, status: default_status, org_unit: org_unit, comp_yr: comp_yr, uuid: item_uuid, version: item_version }), document.getElementById('content'));
